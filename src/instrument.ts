...
Sentry.init({
    ...
    tracesSampleRate:
        process.env.NODE_ENV === ENVIRONMENTS.Production ? 0.1 : 1.0,
    ...
    enabled: process.env.NODE_ENV !== ENVIRONMENTS.Development,
    ...
    // Advanced, optional: Called for transaction events
