...
describe('ProcessHostRestartedNotificationProcessor', () => {
    let processor: ProcessHostRestartedNotificationProcessor;
    ...
    beforeEach(() => {
        queueRepository = {
            consume: jest.fn().mockImplementation((id, config, callback) => {
                callback({
                    ...
                    eventName: 'HOST_RESTARTED_EVENT',
                });
        ...
        processor = new ProcessHostRestartedNotificationProcessor(
            queueRepository,
            notificationRepository,
        );
        ...
        mockHost = {
            id: 'host-123',
            markAsRestartedNotificationSent: jest.fn(),
        } as unknown as Host;
    ...
    it('should process host restarted notification', async () => {
        ...
        expect(mockHost.markAsRestartedNotificationSent).toHaveBeenCalled();
